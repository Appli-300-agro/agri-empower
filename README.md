# agri empower - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **agri empower**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@agriempower.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@agriempower.cm` | `user123` | |
...
*   **Contact :** contact@agriempower.cm